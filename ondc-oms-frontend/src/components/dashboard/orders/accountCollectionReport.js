...
const AccountCollectionReport = ({ sellers, dateRange }) => {
  ...
  useEffect(() => {
    client
      .get(`api/sellers/accountCollectedReport?dateRange=${dateRange}`)
      .then((response) => {
    ...
    <>
      <Col span={16}>
        <div style={{ textAlign: "center" }}>
          <h2>Account Collection Report</h2>
        </div>
        {renderTable()}
      </Col>
...
export default AccountCollectionReport;
